...
|---|---|
| “找高质量播客” | Run discovery and propose scored sources |
| “生成今天的播客日报” | Run the daily pipeline |
| “深挖 2、5” | Resolve today's stable episode numbers, then deep-dive |
| “喜欢/跳过/不喜欢” | Record feedback and adjust future weights |
| “检查订阅源” | Validate RSS sources without sending a digest |
